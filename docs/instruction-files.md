...
1. 사용자의 현재 요청
2. 저장소의 `AGENTS.md`와 하위 디렉터리 규칙
3. 제품·아키텍처의 권위 문서
4. 현재 Issue와 acceptance criteria
5. 현재 Git·런타임·CI 상태
6. `HANDOFF.md`와 `MEMORY.md`

Handoff와 memory는 탐색 경로를 알려주지만 현재 상태를 증명하지 않는다. 변할 수 있는 사실은 반드시 다시 확인한다.
